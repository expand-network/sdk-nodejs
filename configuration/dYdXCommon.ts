...
exports.getSubAccountCompositeClient = async (mnemonic: any, subAccountNumber: any) => {
...
exports.getSubAccountValidatorClient = async (mnemonic: any, subAccountNumber: any) => {
    const wallet = await LocalWallet.fromMnemonic(mnemonic, BECH32_PREFIX);
